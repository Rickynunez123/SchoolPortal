...
$id = $_SESSION['id'];
 // print_r($id);
  ...
  $queryClasses = "SELECT C_ID FROM f_enrolled WHERE S_ID = '$id'";
  //query the code 
...
<form  name='professorView' method='POST' action="studentTally.php">
  <div >
     <div class='plan plan--classes'>
      <div class='card card--primary'>
    ...
    <div class='card__body'>
        ...
        <input type = 'submit' style='border: none; background-color: transparent' name='studentTally' 
        value= "Student_score">
        </input>
            </h2>
        </div>
